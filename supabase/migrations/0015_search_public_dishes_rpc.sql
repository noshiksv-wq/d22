-- B2C Public Search RPC Function
-- High-performance stored procedure for cross-restaurant dish search with geospatial filtering
...
COMMENT ON FUNCTION public.search_public_dishes IS 'B2C public search function for finding restaurants and dishes with geospatial, dietary, and service filtering';
