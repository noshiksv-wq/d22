-- Enhance search_public_dishes RPC to include section information
-- This allows the discovery app to match queries against section names
-- (e.g., "tandoori", "antipasti", "naan") and return section names in results

-- Recreate the function with section support
